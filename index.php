    ...
    <div class="container">
      ...
      <div class="toggle__menu-close" onclick="toggleMenu()">
        <svg width="86" height="86" viewBox="0 0 86 86" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <path fill-rule="evenodd" clip-rule="evenodd"
            d="M46.7879 40.2502L54.4173 32.6208C54.9809 32.0572 54.9809 31.1462 54.4173 30.5826C53.8538 30.019 52.9428 30.019 52.3792 30.5826L44.7497 38.2121L37.1203 30.5826C36.5567 30.019 35.6457 30.019 35.0821 30.5826C34.5185 31.1462 34.5185 32.0572 35.0821 32.6208L42.7116 40.2502L35.0821 47.8797C34.5185 48.4433 34.5185 49.3542 35.0821 49.9178C35.3632 50.1989 35.7322 50.3402 36.1012 50.3402C36.4702 50.3402 36.8392 50.1989 37.1203 49.9178L44.7497 42.2884L52.3792 49.9178C52.6603 50.1989 53.0293 50.3402 53.3983 50.3402C53.7673 50.3402 54.1363 50.1989 54.4173 49.9178C54.9809 49.3542 54.9809 48.4433 54.4173 47.8797L46.7879 40.2502Z"
            fill="#5F4EFA" />
          <defs>
            <filter id="filter0_d" x="0.755249" y="0.893066" width="84.7139" height="84.7139"
              ...
              <div class="row">
                ...
                <div class="col-12 col-md-8 col-lg-8">
                  <div class="card-body">
                    ...
                    <div class="line"></div>
                    <input type="text" id="searchInput" placeholder="Search..." onkeyup="searchText(event)" class="search-input mb-3">
      ...
      <div class="menu">
        ...
        <div id="Log_In" class="menu-icon" onclick="changeMenu('Log_In')">
          <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd"
          ...
          <div class="tooltip" data-key="Log_In">Log_In</div>
        </div>
        <div id="Tutorial" class="menu-icon" onclick="changeMenu('Tutorial')">
          <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd"
          ...
          <div class="tooltip" data-key="Tutorial">Tutorial</div>
        </div>
        <div id="projects" class="menu-icon" onclick="changeMenu('projects')">
          <svg width="26" height="26" viewBox="0 0 26 26" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path fill-rule="evenodd" clip-rule="evenodd"
...
function searchText(event) {
  ...
  if (event.key === 'Enter' && searchTerm) {
    // Redirect to project/index.php with the search term as a query parameter
    window.location.href = `project/index.php?search=${encodeURIComponent(searchTerm)}`;
  }
}
</script>
</html>